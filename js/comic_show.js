...
// i.e. writeNav shows comic navigation, to show it on a page youd use <div class="writeNav"></div> wherever you want it to be. 
...
keyNav(); //enables navigation through the comic with the arrow keys and WSAD. 
// It doesn't need a div with a class name, it automatically works. delete or comment out (add // at the beginning) here to disable.
